...
from app.models import JobListing, PullResult
from app.normalizers.cleaner import clean_description
...
class Phase3Tests(unittest.TestCase):
    ...
    def test_ollama_response_can_validate_new_schema(self) -> None:
        ...
        with (
            ...
            patch("app.normalizers.ollama.request.urlopen", return_value=FakeResponse()),
        ):
    ...
    def test_celery_extract_and_normalize_task_uses_shared_pipeline(self) -> None:
        ...
        with patch("app.tasks.extract_source.run", return_value=fake_extraction):
